...
set(NETCDF_C_LOCAL_SOURCE "D:/project/project_RAT/sources/netcdf-c-v4.9.3")

if(EXISTS "${NETCDF_C_LOCAL_SOURCE}/CMakeLists.txt")
    message(STATUS "Using local netcdf-c source at ${NETCDF_C_LOCAL_SOURCE}")
    set(SOURCE_PATH "${CURRENT_BUILDTREES_DIR}/src/netcdf-c-v${VERSION}-local")
    file(REMOVE_RECURSE "${SOURCE_PATH}")
    file(COPY "${NETCDF_C_LOCAL_SOURCE}/" DESTINATION "${SOURCE_PATH}")
    vcpkg_apply_patches(
