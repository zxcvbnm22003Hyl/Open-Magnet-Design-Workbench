...
# =============================================================================
# Clone & patch
set(VTK_LOCAL_ARCHIVE "D:/project/project_RAT/source-archives/Kitware-VTK-09a76bc55b37caad94d0d8ebe865caaed1b438af.tar.gz")

if(EXISTS "${VTK_LOCAL_ARCHIVE}")
    message(STATUS "Using local VTK archive at ${VTK_LOCAL_ARCHIVE}")
    vcpkg_extract_source_archive_ex(
        OUT_SOURCE_PATH SOURCE_PATH
        ARCHIVE "${VTK_LOCAL_ARCHIVE}"
        ...
        PATCHES
            ...
            octree.patch
            fix-tbbsmptool.patch
            backport-bda8324.diff
