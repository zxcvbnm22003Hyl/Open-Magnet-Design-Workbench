set(SUNDIALS_LOCAL_ARCHIVE "D:/project/project_RAT/source-archives/LLNL-sundials-v7.6.0.tar.gz")

if(EXISTS "${SUNDIALS_LOCAL_ARCHIVE}")
    message(STATUS "Using local sundials archive at ${SUNDIALS_LOCAL_ARCHIVE}")
    vcpkg_extract_source_archive_ex(
        OUT_SOURCE_PATH SOURCE_PATH
        ARCHIVE "${SUNDIALS_LOCAL_ARCHIVE}"
        REF "v${VERSION}"
    )
else()
    vcpkg_from_github(
